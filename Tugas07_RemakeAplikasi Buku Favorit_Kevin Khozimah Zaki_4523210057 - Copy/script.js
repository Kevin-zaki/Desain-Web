...
function tampilkanDaftarBuku() {
    ...
    daftarBuku.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            <p class="text-gray-800">${buku.tampilkanInfo()}</p>
            <div class="mt-2">
                <button onclick="tambahKeFavorit(${index})" class="mr-2 rounded-lg bg-sky-500 hover:bg-sky-700 text-white font-bold py-1 px-3 transition duration-200">Tambah ke Favorit</button>
                <button onclick="hapusDariDaftarBuku(${index})" class="rounded-lg bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 transition duration-200">Hapus</button>
            </div>
        `;
...
function tampilkanBukuFavorit() {
    ...
    bukuFavorit.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            ...
            <button onclick="hapusDariFavorit(${index})" class="rounded-lg bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 transition duration-200"  >Hapus</button>
        `;
